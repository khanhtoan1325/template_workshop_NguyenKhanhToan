...
<div style="text-align: center; margin-bottom: 2rem; font-family: system-ui, -apple-system, sans-serif;">
  ...
  <h1 style="margin: 8px 0; font-size: 2.2rem; font-weight: 700; color: #0f172a; letter-spacing: -0.02em;">Video Localization Platform</h1>
  <p style="color: #64748b; font-size: 1.05rem; margin-top: 0; font-weight: 400;">Automated Video Translation & Dubbing System</p>
  ...
  <div style="display: flex; justify-content: center; gap: 8px; flex-wrap: wrap; margin-top: 14px;">
    ...
    <span style="display: inline-flex; align-items: center; gap: 6px; background: #f8fafc; color: #475569; padding: 5px 12px; border-radius: 6px; font-size: 0.82rem; font-weight: 500; border: 1px solid #e2e8f0;">
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2.18" ry="2.18"/><line x1="10" y1="8" x2="10" y2="16"/><line x1="14" y1="8" x2="14" y2="16"/></svg>
      Video Processing
    </span>
  </div>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 16px; margin-bottom: 2.5rem; font-family: system-ui, -apple-system, sans-serif;">
  ...
  <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px 16px; text-align: center;">
    ...
    <div style="font-size: 1.2rem; font-weight: 700; color: #0f172a;">5-15 minutes</div>
    <div style="font-size: 0.8rem; color: #64748b; margin-top: 2px;">Processing time/video</div>
  </div>
  ...
  <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px 16px; text-align: center;">
    ...
    <div style="font-size: 0.8rem; color: #64748b; margin-top: 2px;">Monthly cost</div>
  </div>
  ...
  <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px 16px; text-align: center;">
    ...
    <div style="font-size: 0.8rem; color: #64748b; margin-top: 2px;">Cost savings</div>
  </div>
  ...
  <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px 16px; text-align: center;">
    ...
    <div style="font-size: 1.2rem; font-weight: 700; color: #0f172a;">14 weeks</div>
    <div style="font-size: 0.8rem; color: #64748b; margin-top: 2px;">Implementation time</div>
  </div>

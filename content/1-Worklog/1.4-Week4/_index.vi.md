...
### Mục tiêu tuần 4:
* Tìm hiểu dịch vụ mạng riêng ảo Amazon VPC và dải địa chỉ IP (CIDR).
* Thực hành tạo lập và phân tách Public Subnet và Private Subnet.
* Cấu hình Route Table và Internet Gateway để cho phép kết nối mạng ra ngoài Internet.
...
* Triển khai thành công Public Subnet (cho tài nguyên cần public) và Private Subnet (cho hệ thống nội bộ).
* Cấu hình Route Tables định tuyến lưu lượng nội bộ (local route).
* Đính kèm thành công Internet Gateway (IGW) và cấu hình route 
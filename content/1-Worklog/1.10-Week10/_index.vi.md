...
| --- | --- | --- | --- | --- |
| 3 | - **Amazon RDS** <br> - Tìm hiểu Relational Database Service <br> - Ghi chú lợi ích managed database <br> - Phân biệt RDS và database tự cài trên EC2 <br> - Tìm hiểu các engine: MySQL, PostgreSQL, MariaDB | 07/07/2026 | 07/07/2026 | <https://cloudjourney.awsstudygroup.com/> |
| 4 | - **RDS MySQL** <br> - Tìm hiểu endpoint, port, username, password <br> - Ghi chú cách kết nối RDS từ bên ngoài <br> - Tìm hiểu Security Group cho database <br> - Phân tích public/private access cho RDS | 08/07/2026 | 08/07/2026 | <https://cloudjourney.awsstudygroup.com/> |
| 5 | - **RDS Backup & Security** <br> - Tìm hiểu automated backup <br> - Tìm hiểu snapshot database <br> - Ghi chú Multi-AZ ở mức cơ bản <br> - Tổng hợp checklist bảo mật database | 09/07/2026 | 09/07/2026 | <https://cloudjourney.awsstudygroup.com/> |
| 6 | - **Dự Án Nhóm**<br>- Xây dựng layout Editor chính cho ứng dụng<br>- Thiết kế layout 4 vùng: MenuList (sidebar), MenuItem (panel), Scene (player), Timeline (dòng thời gian)<br>- Tích hợp react-resizable-panels cho phép kéo thay đổi kích thước<br>- Xây dựng Navbar: tên video, resize canvas (16:9 / 9:16 / 1:1), dropdown user menu, nút download<br>- Xây dựng MenuList sidebar 9 icon: Upload, Subtitle, Dubbing, Render, Audio, Logo, Settings, User<br>- Cấu hình React Router v6: route /, /auth, /auth/register | 10/07/2026 | 10/07/2026 | <https://www.remotion.dev/> <br> <https://ui.shadcn.com/> |
